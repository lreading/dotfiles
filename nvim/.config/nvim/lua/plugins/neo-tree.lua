return {
  {
    ...
    config = function()
      vim.keymap.set("n", "<leader>tr", ":Neotree filesystem reveal left toggle=true<CR>", { desc = "Toggle Neo-tree file reveal" })
          ...
          commands = {
            conditional_enter = function(state)
              ...
              if node.type == "message" then
                ...
                require("neo-tree.sources.filesystem.commands").open(state, { open_in_current = true })
              end
            end,
          },
